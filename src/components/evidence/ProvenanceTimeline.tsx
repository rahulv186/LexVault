...
import { CheckCircle2, Clock, Lock, Globe, Database, ShieldCheck, Upload, Hash, LucideIcon } from 'lucide-react';
...
const PROVENANCE_STEPS: ProvenanceStep[] = [
...
const Step: React.FC<StepProps> = ({ step, isLast, isCompleted }) => {

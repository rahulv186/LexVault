...
import { ArrowDown, ArrowRight, Cpu, Lock, Globe, Database, Shield, Zap, Layers, ShieldCheck, LucideIcon } from 'lucide-react';
...
const ArchNode: React.FC<ArchNodeProps> = ({ icon: Icon, title, tech, description, color = 'text-gray-400' }) => (
